...
const Footer = () => {
  return (
    <footer className="py-12 px-4 font-inter bg-gray-950 border-t border-gray-800" 
    // style={{
    //     background:
    //       "radial-gradient(125% 125% at 80% 80%, #000000 40%, #123225 100%)",
    //   }}
      >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl">
...
<div className="flex items-center">
          ...
          <div className="flex space-x-5 pt-2">
            <a
              href="#"
              className="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-green-500 transition-transform transform hover:scale-110"
            >
              <GitHubIcon size={28} />
            </a>
            <a
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            <li>
              <a
                href="#"
                className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-green-500 transition-colors duration-300"
              >
                Features
              </a>
            </li>
      ...
      <div className="text-center flex flex-col md:flex-row justify-center md:justify-between items-center text-gray-500 dark:text-gray-400 text-sm pt-10 mt-10 border-t border-gray-800 dark:border-gray-700 max-w-7xl mx-auto">
  <p>
    &copy; {new Date().getFullYear()} MockMiya. All rights reserved.
  </p>
