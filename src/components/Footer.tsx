...
<div className="flex items-center">
      ...
      <div className="text-center flex flex-col md:flex-row justify-center md:justify-between items-center text-gray-500 dark:text-gray-400 text-sm pt-10 mt-10 border-t border-gray-200 dark:border-gray-700 max-w-7xl mx-auto">
  <p>
