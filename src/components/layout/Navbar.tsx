                  ...
                  {showProfileDropdown && (
                    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 6 }} className="absolute right-0 mt-2 w-56 bg-card border border-card-border rounded-lg shadow-lg z-50 overflow-hidden">
                      ...
                      <div className="p-1">
                        ...
                        <Link
                          href={dashboardPath}
                          className="flex items-center gap-3 px-3 py-2 text-sm hover:bg-secondary rounded-md transition-colors"
                        >
                ...
                <div className="pt-3 border-t border-border">
                  {user ? (
                    <>
                      ...
                      <Link
  href={dashboardPath}
  className="block px-3 py-2 rounded-md hover:bg-secondary transition"
>
  Dashboard
</Link>
