      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <header className="text-center mb-20">
          <div className="relative w-full md:w-auto">
            <div className="bg-gradient-to-r from-green-500 to-blue-500 px-6 md:px-16 py-6 md:py-10 rounded-none md:rounded-2xl shadow-2xl relative z-10">
              ...
              <p className="text-sm md:text-2xl  mt-3 md:mt-4 font-medium tracking-wide">
        ...
        <section className="space-y-16">
          {blogPosts.map((post, index) => (
            <div
              key={post.id}
              className={`flex flex-col lg:h-72 md:flex-row ${
                index % 2 === 1 ? "md:flex-row-reverse" : ""
              } items-center gap-8 bg-card rounded-3xl border shadow-lg overflow-hidden`}
            >
              {/* Blog Image */}
              <div className="w-full md:w-1/2">
                <Image
                  ...
                  width={600}
                  height={400}
                  className="w-full h-64 md:h-full object-center"
                />
              </div>
