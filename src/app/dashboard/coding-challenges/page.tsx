    ...
    <PrivateRoute>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 p-4 lg:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`grid gap-6 lg:gap-8 ${showLeftPanel ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'
            }`}>
                      ...
                      <div className="grid gap-3">
                        {defaultQuizConfigs.map((configOption, index) => (
                          <motion.button
                            ...
                            className={`p-4 rounded-2xl border-2 transition-all duration-200 text-left ${config.duration === configOption.duration && !isCustomizing
                        ...
                        <motion.button
                          ...
                          className={`p-4 rounded-2xl border-2 transition-all duration-200 text-left ${isCustomizing
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
              className={`bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-6 lg:p-8 ${!showLeftPanel ? 'lg:col-span-2' : ''
                }`}
            >
              <motion.h2
                className="text-2xl font-bold text-gray-800 mb-6"
                    ...
                    >
                      ...
                      <div className="flex border-b border-gray-200">
                        <button
                          ...
                          className={`flex-1 py-3 font-semibold border-b-2 ${showReview
                      ...
                      <div className="space-y-6 max-h-[500px] overflow-y-auto">
                        {allAnswers.map((item, index) => (
                          <motion.div
                            ...
                            className={`p-4 rounded-2xl border-2 ${item.isCorrect
                          ...
                          >
                            <div className="flex items-start justify-between mb-3">
                              <div>
                                ...
                                <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${item.isCorrect
                            ...
                            <div className="mb-2">
                              ...
                              <div className={`p-3 rounded-lg mt-1 ${item.isCorrect
                                  ? 'bg-green-100 border border-green-200'
                                  : 'bg-red-100 border border-red-200'
                                }`}>
                                <span className={`font-medium ${item.isCorrect ? 'text-green-800' : 'text-red-800'
                                  }`}>
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <p className={`text-2xl font-bold ${quizState.timeRemaining < 60 ? 'text-red-300 animate-pulse' : 'text-white'
                            }`}>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center">
                                <span className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 font-semibold ${isSelected
